...
- 功率板的主要作用：通过升压模块将 $16V$ 电压升高至 $200V$，进而给电磁铁供电，并接受控制板的踢球信号控制电磁铁踢球。
...
- 新功率板原理图及PCB设计（嘉立创）：[交大云盘](https://jbox.sjtu.edu.cn/l/D1hrNt)
...
<div align="center">
    <img src="https://github.com/Gnitnaux/POWBRD/blob/master/%E8%80%81%E5%8A%9F%E7%8E%87%E6%9D%BF%E5%85%85%E7%94%B5%E4%BD%BF%E8%83%BD%E7%94%B5%E8%B7%AF.png?raw=true" alt="充电使能电路" width="500">
</div>
...
### 5、水泥电阻保护电路的作用（对于老功率板）

老功率板中有一块被长期称作“延时电路”的部分，其作用一直被我们所忽略。实际上，该电路在 Q3 损坏的情况下能够起到重要的电路保护作用。由于其保护作用，在此将该部分电路重新命名为“水泥电阻保护电路”。

<div align="center">
    <img src="https://github.com/Gnitnaux/POWBRD/blob/master/%E6%B0%B4%E6%B3%A5%E7%94%B5%E9%98%BB%E4%BF%9D%E6%8A%A4%E7%94%B5%E8%B7%AF.png?raw=true" alt="水泥电阻保护电路" width="500">
</div>

在正常情况下，水泥电阻放电电路处 Q3 关断，此时放电部分通过 $510k\Omega$ 电阻放电。将视野放大，可视为 R7、R8 两个 $10\Omega$ 电阻与 $510k\Omega$ 电阻分压得到测试点 TP6 处的电压。由于 $510k\Omega >> 10\Omega$，此时 TP6 电压与 $16V$ 十分接近（经测量，TP6 电压仅比电池电压小 $0.2V$），这使得 Q1、Q2 这两个PNP型三极管 $U_b = U_e$，不被导通（导通条件为 $U_e>U_b$）。因此，此时CHG_END为低从而允许上电； Q4 的 $U_g$ 为低而导通，功率板正常工作。

而在 Q3 损坏时(通常情况下是被击穿)，放电部分即通过水泥电阻与 Q3 放电，该路电阻约为几百欧，与 R7、R8分压之后 TP6 电压会明显小于 $16V$ （经测量，此时 TP6 电压比电池电压小 $2V$），这使得 Q1、Q2 的 $U_e>U_b$，因而导通。导通之后 CHG_END 为高从而阻止了上电，Q4也被关断，因此功率板处于被保护的状态。

若没有该区域电路的保护，在 Q3 损坏时升压电路仍继续工作 $220V$ 电压直接通过水泥电阻进行放电，在这种情况下，电池电量会迅速地被消耗，同时水泥电阻会出现严重的发热情况，这对于电池的维护以及机器人的安全性都有不利影响。
